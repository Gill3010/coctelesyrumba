    ...
    <div className="mt-12 space-y-6">
      ...
      <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-cyan-600 rounded-2xl p-8 text-center border-4 border-cyan-400 shadow-[0_0_30px_rgba(34,211,238,0.6)]">
        ...
        <div className="mt-8 pt-6 border-t border-cyan-400/30">
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/50767175921"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2 transition-transform hover:scale-110"
            aria-label="WhatsApp"
          >
            <div className="bg-[#25D366] p-4 rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(37,211,102,0.6)] transition-all">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/coctelesyrumba507?igsh=MWFqZGFyNWMwZ3NucA=="
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2 transition-transform hover:scale-110"
            aria-label="Instagram"
          >
            <div className="bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 p-4 rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(225,48,108,0.6)] transition-all">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
          ...
          {/* Facebook */}
          <a
            href="https://www.facebook.com/people/cocteleyrumba/61567008620414/"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2 transition-transform hover:scale-110"
            aria-label="Facebook"
          >
            <div className="bg-[#1877F2] p-4 rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(24,119,242,0.6)] transition-all">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
          ...
          {/* TikTok */}
          <a
            href="https://www.tiktok.com/@coctelesyrumba?_r=1&_t=ZM-92DhotICDzo"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2 transition-transform hover:scale-110"
            aria-label="TikTok"
          >
            <div className="bg-black p-4 rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(0,0,0,0.6)] transition-all">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
      ...
      <div className="text-center py-4">
        <p className="text-sm md:text-base text-cyan-300/70">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-cyan-300 font-semibold drop-shadow-[0_0_8px_rgba(34,211,238,0.5)] hover:text-cyan-200 transition-colors underline"
          >
            Innova Proyectos
          </a>
        </p>
